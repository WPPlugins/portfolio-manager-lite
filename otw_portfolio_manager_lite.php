	...
	class OTWPortfolioManagerLite{
		...
		*/
		...
		public function load_resources(){
			...
			$otw_pml_factory_object->add_plugin( $otw_pml_plugin_id, __FILE__, array( 'menu_parent' => $this->menu_parent, 'lc_name' => __( 'License Manager', OTW_PML_TRANSLATION ), 'menu_key' => 'otw-pml' ) );
		...
		public function pm_settings () {
			...
			if( !empty( $_POST ) && isset( $_POST['otw_pm_save_settings'] ) && ( $_POST['otw_pm_save_settings'] == 1 ) )
			{
				...
				if( isset( $_POST['otw_pm_promotions'] ) && !empty( $_POST['otw_pm_promotions'] ) ){
					...
					update_option( $otw_pml_plugin_id.'_dnms', $_POST['otw_pm_promotions'] );
